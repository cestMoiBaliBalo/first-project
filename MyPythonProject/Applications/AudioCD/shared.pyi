...
class AudioGenres(object):
    ...
    def get_genres(self, artistsort: str, fallback: str = ...) -> str:
...
class CommonAudioCDTags(AudioCDTags):
    ...
    def __init__(self, audiogenres: Any, sequence: str, **kwargs: Any) -> None: ...
...
class RippedTrack(ContextDecorator):
    ...
    _tabs = ...  # type: int
    _in_logger = ...  # type: Any
    def __init__(self, rippingprofile: str, file, sequenc: str, *decoratingprofiles: str, audiogenres: Any= ...) -> None: ...
    @property
...
def upsert_audiotags(profile: str, source: IO, sequence: str, *decorators: str, audiogenres: Any = ..., **kwargs: Any) -> Tuple[int, AudioCDTags]: ...
