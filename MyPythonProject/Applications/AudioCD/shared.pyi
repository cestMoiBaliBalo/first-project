...
class RippedTrack(ContextDecorator):
    ...
    _tabs = ...  # type: int
    _in_logger = ...  # type: Any
    def __init__(self, rippingprofile: str, file: IO, sequenc: str, *decoratingprofiles: str, **kwargs: Any) -> None:
    ...
    @staticmethod
    def alter_tags(audiotrack: AudioCDTags, *decorators: str, **kwargs: Any) -> Any: ...
    def __enter__(self) -> RippedTrack: ...
    def __exit__(self, exc_type, exc_val, exc_tb) -> None: ...


def album(track) -> str: ...
def albums(track: DefaultAudioCDTags, *, fil: Optional[str] = ..., encoding: str = ..., db: str = ...) -> Iterator[Tuple[str, Sequence[Union[int, str]]]]: ...
def bootlegs(track: BootlegAudioCDTags, *, fil: Optional[str] = ..., encoding: str = ..., db: str = ...) -> Iterator[Tuple[str, Sequence[Union[int, str]]]]: ...
...
def dump_xreferences(track: Sequence[Union[bool, str]], *, fil: Optional[str] = ..., encoding: str = ...) -> None: ...
def filcontents(fil) -> Iterable[str]: ...
def get_tagsfile(obj) -> str: ...
def get_xreferences(track: Union[PureWindowsPath, str]) -> Tuple[bool, Tuple[Any, ...]]: ...
...
def upsert_audiotags(profile: str, source: IO, sequence: str, *decorators: str, genres: Any = ..., languages: Any = ..., encoders: Any = ..., **kwargs: Any) -> Tuple[int, AudioCDTags]: ...
