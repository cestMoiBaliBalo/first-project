...
def find_files(directory: Union[str, Path], *, excluded=...) -> Iterator[str]: ...
def format_collection(collection: Iterable[Tuple[Any, ...]], *, tabsize: int = ..., gap: int = ..., group: Optional[int] = ...) -> Iterator[Tuple[str, ...]]: ...
...
def get_artists(directory: str = ...) -> Iterator[Tuple[str, str]]: ...
...
def iter_collection(collection: Iterable[Tuple[Any, ...]], headers: Optional[Iterable[str]], *, char: str = ..., tabsize: int = ..., gap: int = ..., group: Optional[int] = ...) -> Iterator[str]: ...
...
def pprint_count(*iterables: Tuple[str, int], length: int = ...) -> Iterator[Tuple[str, str]]: ...
def pprint_mapping(*iterables: Tuple[Union[int, str], Union[int, str]]) -> Iterator[Tuple[str, Union[int, str]]]: ...
def pprint_sequence(*items: Union[int, str]) -> Iterator[str]: ...
