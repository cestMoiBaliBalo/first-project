...
def create_tables(db: str) -> str:
    ...
    with ExitStack() as stack:
        ...
        conn.execute("CREATE VIEW IF NOT EXISTS tracks_vw AS "
                     ...
                     "LEFT OUTER JOIN (SELECT a.albumid, a.date, a.city, a.countryid, cou.country, a.tour FROM livealbums a INNER JOIN countries cou ON a.countryid = cou.countryid) liv ON liv.albumid = "
                     "boot.albumid")
